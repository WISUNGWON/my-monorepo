...
// Ref : https://ui.toast.com/weekly-pick/ko_20210630
...
function renderComplexForm(props?: Partial<ComplexFormProps>) {
  ...
  const result = render(
    <ComplexForm onSubmit={onSubmit} onCancel={onCancel} {...props} />
  );
  ...
  const FavoriteDrinkInput = () =>
    result.queryByLabelText('What is your favorite drink?');
